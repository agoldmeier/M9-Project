...
Below, I am attempting to change the street names from all upper case to normal formatting. This would be the first letter being upper case and the following to be lower. 
